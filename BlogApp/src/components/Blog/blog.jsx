             ...
             className="mt-[80px] ">
                <div className="flex justify-center">
                    <div className="w-[100%] md:w-auto flex justify-around gap-4 pl-[30px] pr-[30px] md:gap-[60px] flex-col md:flex-row ">
                        ...
                        <button onClick={navigateCreateBlog} className="cssbuttons-io border-1  pt-2 pb-2"> <span><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><IoCodeSlashSharp style={{fontSize:'25px'}}/></svg>Create</span></button>
                    </div>  
                </div>
            </div>
            <ShowBlog blog={blog}/>
